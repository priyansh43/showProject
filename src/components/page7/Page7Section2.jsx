      ...
      {isMobile ? (
        <div className="flex flex-col items-center gap-6  py-8">
          ...
          <div className="pr-16px-mvw max-w-[90%]">
            <SectionHeading title="REDEFINING DESIGN STRATEGY. DRIVING INNOVATION." />
          </div>
          ...
          <p className="md:text-[5.25vw] text-[4.27vw] opacity-80 font-montserrat font-medium text-[#1C1C1C] leading-[7.47vw] md:leading-[1.5] md:text-center px-[4.27vw] md:px-0 ">
            Enter the world of Strategic Design Management with ATLAS ISDI’s
            B.Des program—where creative problem-solving meets business strategy
            to drive innovation. Here, students master human-centered design,
            brand strategy, and design-led innovation to create impactful
            solutions. With a focus on market research, UX insights, and
            sustainable business models, our curriculum prepares students to
            transform design thinking into strategic value, ready to lead and
            shape the future of design-driven industries.
          </p>
          ...
          <div className="flex flex-col justify-between items-start  w-full md:w-[42.3480vw]">
            ...
            <div>
              <h1 className="md:text-[3.03vw] w-full text-[7.47vw] font-montserrat font-bold uppercase  text-[#1C1C1C]">
                REDEFINING DESIGN STRATEGY. DRIVING INNOVATION.
              </h1>
            </div>
            {/* slider */}
        ...
        <Section3Slider />
            ...
            <div className="md:w-[43.1771vw] w-[90vw] py-40px-vw">
              <p className="text-[5.25vw] md:text-[1.15vw] opacity-60 font-montserrat font-medium text-[#1C1C1C] leading-[1.5]">
                Enter the world of Strategic Design Management with ATLAS ISDI’s
                B.Des program—where creative problem-solving meets business
                strategy to drive innovation. Here, students master
                human-centered design, brand strategy, and design-led innovation
                to create impactful solutions. With a focus on market research,
                UX insights, and sustainable business models, our curriculum
                prepares students to transform design thinking into strategic
                value, ready to lead and shape the future of design-driven
                industries.
              </p>
            </div>
