      ...
      {isMobile ? (
        <div className="flex flex-col items-center gap-6  py-8">
          ...
          <div className="pr-16px-mvw max-w-[90%]">
            <SectionHeading title="UNLEASHING FASHION INNOVATION. SHAPING TRENDS." />
          </div>
          ...
          <p className="md:text-[5.25vw] text-[4.27vw] opacity-80 font-montserrat font-medium text-[#1C1C1C] leading-[7.47vw] md:leading-[1.5] md:text-center px-[4.27vw] md:px-0 ">
            Dive into the dynamic world of fashion communication with ATLAS
            ISDI’s B.Des Fashion Communication & Styling program. Here,
            creativity and strategy converge to empower you to shape trends and
            tell compelling stories through fashion. You’ll explore the power of
            styling, digital media, and brand identity to create powerful visual
            narratives that resonate across diverse platforms. Our curriculum
            integrates the latest industry trends with design thinking,
            equipping you with the skills to drive innovation and lead in the
            ever-evolving fashion communication landscape.
          </p>
          ...
          <div className="flex flex-col justify-between items-start  w-full md:w-[42.3480vw]">
            ...
            <div>
              <h1 className="md:text-[3.03vw] w-full text-[7.47vw] font-montserrat font-bold uppercase  text-[#1C1C1C]">
                UNLEASHING FASHION INNOVATION. SHAPING TRENDS.
              </h1>
            </div>
            {/* slider */}
        ...
        <Section3Slider />
            ...
            <div className="md:w-[43.1771vw] w-[90vw] py-40px-vw">
              <p className="text-[5.25vw] md:text-[1.15vw] opacity-60 font-montserrat font-medium text-[#1C1C1C] leading-[1.5]">
                Dive into the dynamic world of fashion communication with ATLAS
                ISDI’s B.Des Fashion Communication & Styling program. Here,
                creativity and strategy converge to empower you to shape trends
                and tell compelling stories through fashion. You’ll explore the
                power of styling, digital media, and brand identity to create
                powerful visual narratives that resonate across diverse
                platforms. Our curriculum integrates the latest industry trends
                with design thinking, equipping you with the skills to drive
                innovation and lead in the ever-evolving fashion communication
                landscape.
              </p>
            </div>
