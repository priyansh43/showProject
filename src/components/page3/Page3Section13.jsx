...
export const Page3Section13 = () => {
  return (
    <div className="flex flex-col md:flex-row gap-y-[5vw] md:gap-x-[5.94vw] justify-between items-start px-16px-mvw md:px-[7.29vw] w-full mt-[7.81vw]">
