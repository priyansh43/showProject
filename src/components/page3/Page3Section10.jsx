...
import { dummyDataSection12, section12data } from "../../data/home"; // Your existing data for Section12
import Section12CardMobile from "../slider/Section12CardMobile";
import SectionHeading from "../Heading/SectionHeading";
import Section12Card from "../card/Section12Card";
...
const CustomArrow = ({ direction, onClick }) => (
  <button
    ...
    style={{
      bottom: "-10vh",
      [direction === "left" ? "right" : "left"]: "38.47vw", // Adjust position based on direction
    }}
    onClick={onClick}
  >
    <img
...
const Page3Section10 = () => {
  ...
  return (
    <div className="md:px-[7.083vw] px-16px-mvw  ">
      {/* Desktop Grid Layout */}
      <div className="w-[100vw] md:w-[65.2vw]">
