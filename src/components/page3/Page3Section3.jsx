...
import { PAGE2SECTIONFAQ } from "../../data/SecondPage";
import { THIRDPAGESECTION2 } from "../../data/ThirdPage";

export const Page3Section3 = () => {
  return (
    <div className="flex flex-col md:flex-row gap-y-[5vw] md:gap-x-[5.885vw] items-start px-16px-mvw md:px-[7.29vw] w-full">
      ...
      <div className="hidden md:block flex-1">
        <LeftComponent
          title="Why Choose Atlas Isdi For Interior Design"
