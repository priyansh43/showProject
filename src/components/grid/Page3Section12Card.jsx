...
const Page3Section12Card = () => {
  return (
    <div>
      {/* Original Section */}
      <div className="flex flex-col-reverse md:flex-row  items-center  md:mx-[7.17vw] mx-0  mt-30px-mvw md:mt-0">
        {/* Left Section */}
        ...
        {/* Right Section */}
        <div className="w-full md:w-[35.1vw]">
          ...
          <img
            ...
            className="w-full md:h-[28.65vw] h-[90.93vw] object-cover mt-[24px] md:mt-0"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start w-full md:px-0 px-16px-mvw md:mx-[7.17vw] mt-[7.81vw]">
        ...
        <div className="w-full md:w-[35.1vw] mt-[24px] md:mt-0">
          <img
            src="/images/home/section2/sectionbg.jpg"
            alt="Visual Representation"
            className="w-full md:h-[28.65vw] h-[90.93vw] object-cover"
          />
        </div>
