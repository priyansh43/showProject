...
import { Page2section3Mobile } from "../../data/SecondPage";

const Page2Section3Slider = ({ showContent }) => {
  ...
  const images = Page2section3Mobile();
...
export default Page2Section3Slider;
