...
const Page11Section6Card = ({ heading, paragraph, img1, img2, rightImg,padding }) => {
  ...
  return (
    <div className='flex md:flex-row flex-col items-center justify-between md:pt-80px-vw gap-75px-vw' >
      ...
      <div className='md:w-[49.48vw] w-full'>
       ...
       <div className='pt-60px-vw hidden md:flex flex-row gap-60px justify-between'>
...
export default Page11Section6Card  
