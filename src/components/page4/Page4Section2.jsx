      ...
      {isMobile ? (
        <div className="flex flex-col items-center gap-6  py-8">
          ...
          <div className="pr-16px-mvw max-w-[90%]">
            <SectionHeading title="IGNITING CREATIVITY. LEADING DESIGN INNOVATION." />
          </div>
          ...
          <p className="md:text-[5.25vw] text-[4.27vw] opacity-80 font-montserrat font-medium text-[#1C1C1C] leading-[7.47vw] md:leading-[1.5] md:text-center px-[4.27vw] md:px-0 ">
            Step into the world of communication design with ATLAS ISDI’s B.Des
            Communication Design program—where creativity meets strategy to
            craft impactful visual experiences. Here, you’ll learn to
            communicate ideas through innovative design, embracing the latest
            trends in digital media, branding, and user experience.With a focus
            on design thinking and storytelling, our curriculum prepares you to
            lead and innovate in the dynamic field of communication design.
          </p>
          ...
          <div className="flex flex-col justify-between items-start  w-full md:w-[42.3480vw]">
            ...
            <div>
              <h1 className="md:text-[3.03vw] w-full text-[7.47vw] font-montserrat font-bold uppercase  text-[#1C1C1C]">
                IGNITING CREATIVITY. LEADING DESIGN INNOVATION.
              </h1>
            </div>
            {/* slider */}
        ...
        <Section3Slider />
            ...
            <div className="md:w-[43.1771vw] w-[90vw] py-40px-vw">
              <p className="text-[5.25vw] md:text-[1.15vw] opacity-60 font-montserrat font-medium text-[#1C1C1C] leading-[1.5]">
                Step into the world of communication design with ATLAS ISDI’s
                B.Des Communication Design Program—where creativity meets
                strategy to craft impactful visual experiences. Here, you’ll
                learn to communicate ideas through innovative design, embracing
                the latest trends in digital media, branding, and user
                experience.With a focus on design thinking and storytelling, our
                curriculum prepares you to lead and innovate in the dynamic
